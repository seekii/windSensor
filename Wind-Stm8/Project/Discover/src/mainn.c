...
//static void Uart1_SendByte(u8 data);
//static void Uart1_SendString(u8* Data, u16 len);
...
void USART1_initialize(void)
{
        ...
        USART_Init(USART1,BaudRate_9600,USART_WordLength_8b,USART_StopBits_1, USART_Parity_No, (USART_Mode_TypeDef)(USART_Mode_Tx | USART_Mode_Rx));
...
/********************
seekii usart functions
*********************/
void Uart1_SendByte(u8 data)
{
  USART_SendData8(USART1,(unsigned char)data);
  //USART_GetFlagStatus(USART_TypeDef* USARTx, USART_FLAG_TypeDef USART_FLAG)
